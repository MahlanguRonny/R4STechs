class StoreProductsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @store_product.save
        ...
        format.json { render action: 'show', status: :created, location: @store_product }
      else
  ...
  private
    ...
    def store_product_params
      params.require(:store_product).permit(:name, :categoryid, :quantity, :supplierid, :image_url, :price)
    end
end
